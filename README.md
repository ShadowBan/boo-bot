...
BooBot is a chat bot built on the [Hubot][hubot] framework. It was
...
### Running BooBot Locally

You can test your hubot by running the following, however some plugins will not
behave as expected unless the [environment variables](#configuration) they rely
upon have been set.

You can start BooBot locally by running:
...
Then you can interact with BooBot by typing `BooBot help`.

    BooBot> BooBot help
    BooBot animate me <query> - The same thing as `image me`, except adds [snip]
    BooBot help - Displays all of the help commands that BooBot knows about.
    ...
